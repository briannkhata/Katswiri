...
namespace Katswiri {
    ...
    public partial class productsDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProductsRow AddProductsRow(string ProductCode, string ProductName, string BarCode, int UnitId, int CategoryId, double SellingPrice, int ShopId, int Deleted, int TaxTypeId) {
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public double SellingPrice {
                get {
                    return ((double)(this[this.tableProducts.SellingPriceColumn]));
                }
                set {
            ...
            public int ShopId {
                get {
                    return ((int)(this[this.tableProducts.ShopIdColumn]));
                }
                set {
                    this[this.tableProducts.ShopIdColumn] = value;
                }
            }
            ...
            public int Deleted {
                get {
                    return ((int)(this[this.tableProducts.DeletedColumn]));
                }
                set {
            ...
            public int TaxTypeId {
                get {
                    return ((int)(this[this.tableProducts.TaxTypeIdColumn]));
                }
                set {
                    this[this.tableProducts.TaxTypeIdColumn] = value;
                }
            }
        }
...
namespace Katswiri.productsDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([ProductId] = @Original_ProductId) AND ([ProductCode] = @Original_ProductCode) AND ([ProductName] = @Original_ProductName) AND ([UnitId] = @Original_UnitId) AND ([CategoryId] = @Original_CategoryId) AND ([SellingPrice] = @Original_SellingPrice) AND ([ShopId] = @Original_ShopId) AND ([Deleted] = @Original_Deleted) AND ([TaxTypeId] = @Original_TaxTypeId))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([ProductCode], [ProductName], [BarCode], [UnitId], [CategoryId], [SellingPrice], [ShopId], [Deleted], [TaxTypeId]) VALUES (@ProductCode, @ProductName, @BarCode, @UnitId, @CategoryId, @SellingPrice, @ShopId, @Deleted, @TaxTypeId);
SELECT ProductId, ProductCode, ProductName, BarCode, UnitId, CategoryId, SellingPrice, ShopId, Deleted, TaxTypeId FROM Products WHERE (ProductId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Products] SET [ProductCode] = @ProductCode, [ProductName] = @ProductName, [BarCode] = @BarCode, [UnitId] = @UnitId, [CategoryId] = @CategoryId, [SellingPrice] = @SellingPrice, [ShopId] = @ShopId, [Deleted] = @Deleted, [TaxTypeId] = @TaxTypeId WHERE (([ProductId] = @Original_ProductId) AND ([ProductCode] = @Original_ProductCode) AND ([ProductName] = @Original_ProductName) AND ([UnitId] = @Original_UnitId) AND ([CategoryId] = @Original_CategoryId) AND ([SellingPrice] = @Original_SellingPrice) AND ([ShopId] = @Original_ShopId) AND ([Deleted] = @Original_Deleted) AND ([TaxTypeId] = @Original_TaxTypeId));
SELECT ProductId, ProductCode, ProductName, BarCode, UnitId, CategoryId, SellingPrice, ShopId, Deleted, TaxTypeId FROM Products WHERE (ProductId = @ProductId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, ProductCode, ProductName, BarCode, UnitId, CategoryId, SellingP" +
                "rice, ShopId, Deleted, TaxTypeId FROM dbo.Products";
        ...
        public virtual int Delete(int Original_ProductId, string Original_ProductCode, string Original_ProductName, int Original_UnitId, int Original_CategoryId, double Original_SellingPrice, int Original_ShopId, int Original_Deleted, int Original_TaxTypeId) {
            ...
            this.Adapter.DeleteCommand.Parameters[6].Value = ((int)(Original_ShopId));
            this.Adapter.DeleteCommand.Parameters[7].Value = ((int)(Original_Deleted));
            this.Adapter.DeleteCommand.Parameters[8].Value = ((int)(Original_TaxTypeId));
        ...
        public virtual int Insert(string ProductCode, string ProductName, string BarCode, int UnitId, int CategoryId, double SellingPrice, int ShopId, int Deleted, int TaxTypeId) {
            if ((ProductCode == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[6].Value = ((int)(ShopId));
            this.Adapter.InsertCommand.Parameters[7].Value = ((int)(Deleted));
            this.Adapter.InsertCommand.Parameters[8].Value = ((int)(TaxTypeId));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Deleted));
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(TaxTypeId));
            ...
            this.Adapter.UpdateCommand.Parameters[12].Value = ((int)(Original_UnitId));
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(Original_CategoryId));
            this.Adapter.UpdateCommand.Parameters[14].Value = ((double)(Original_SellingPrice));
            this.Adapter.UpdateCommand.Parameters[15].Value = ((int)(Original_ShopId));
            this.Adapter.UpdateCommand.Parameters[16].Value = ((int)(Original_Deleted));
            this.Adapter.UpdateCommand.Parameters[17].Value = ((int)(Original_TaxTypeId));
        ...
        public virtual int Update(
                    ...
                    int Original_Deleted, 
                    int Original_TaxTypeId) {
            return this.Update(ProductCode, ProductName, BarCode, UnitId, CategoryId, SellingPrice, ShopId, Deleted, TaxTypeId, Original_ProductId, Original_ProductCode, Original_ProductName, Original_UnitId, Original_CategoryId, Original_SellingPrice, Original_ShopId, Original_Deleted, Original_TaxTypeId, Original_ProductId);
        }
    }
